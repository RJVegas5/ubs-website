...
import LeadsViewComponent from "./components/LeadsView";
        ...
        <div className="flex-1 overflow-auto p-6">
          <AnimatePresence mode="wait">
            <motion.div key={view} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} transition={{ duration: 0.2 }}>
              {view === "dashboard" && <DashboardViewComponent onNavigate={(v) => setView(v as AdminView)} />}
              {view === "leads" && <LeadsViewComponent />}
